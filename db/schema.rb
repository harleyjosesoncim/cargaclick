...
ActiveRecord::Schema[7.1].define(version: 2025_09_09_180200) do
  ...
  create_table "cotacoes", force: :cascade do |t|
    ...
    t.index ["frete_id", "transportador_id"], name: "idx_cotacoes_frete_transportador", unique: true
  ...
  create_table "pagamentos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["frete_id", "transportador_id"], name: "idx_pagamentos_frete_transportador"
  end
