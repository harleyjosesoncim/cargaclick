...
gem "tailwindcss-rails", "~> 4.1"      # TailwindCSS v4 (Render pede v4+)
...
group :production do
  ...
  # gem "rails_12factor"                # só se usar Heroku
...
group :development do
  gem "rb-fsevent", "~> 0.11", require: false  # macOS watcher
  gem "rb-inotify", "~> 0.11", require: false  # Linux watcher
end
